  ...
  return (
    <div className="min-h-[calc(100vh-10rem)] pt-16 flex items-start bg-gradient-to-b from-gray-900 to-purple-900 ">
      <div className="w-full max-w-4xl mx-auto p-4">
        <div className="rounded-xl shadow-lg border-2 hover:shadow-xl transition-transform">
          {/* Profile Header */}
              ...
              <div className="bg-base-200 rounded-lg p-4">
                <div className="space-y-2">
                  {[1, 2, 3].map((_, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-2 border-b border-base-300 last:border-none"
                    >
